...
namespace UnityStandardAssets.Effects
{
    public class Hose : MonoBehaviour
    {
        ...
        private void Update()
        {
            m_Power = Mathf.Lerp(m_Power, GeoWorldInputCompat.GetMouseButton(0) ? maxPower : minPower, Time.deltaTime*changeSpeed);

            if (GeoWorldInputCompat.GetKeyDown(KeyCode.Alpha1))
            {
